...
facility = {
    'id': 1,
    'parentfacilityid': None,
    'geographiczoneid': 12,
    'name': 'Village Dispensary'
}
...
facilityAddGeoLevels(facility, geoZoneTable)
print facility
...
prints;
{
    ...
    'geographiczoneid': 12,
    'name': 'Village Dispensary',
                                       <--- The key/values below here are new
    'district_id': 12,
    'district_parentid': 9,
    'district_geo_level_code': 'dist'

    'province_id': 9,
    'province_parentid': 6,
    'province_geo_level_code': 'prov',
}
